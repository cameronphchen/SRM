...
#          run_exp_loo.py  HA  100  1300  2201
#
...
movie_data_lh_loo = np.delete(movie_data_lh, loo,2) 
movie_data_rh_loo = np.delete(movie_data_rh, loo,2)
...
for i in range(para['niter']/para['niter_unit']):
  ...
  if align_algo[0:-1] in ['HA_loo', 'HA_shuffle_loo'] :
    new_niter_lh = HA(movie_data_lh_loo, options, para, 'lh')
    new_niter_rh = HA(movie_data_rh_loo, options, para, 'rh')
  elif align_algo[0:-1] in ['HA_rand_loo'] :
    new_niter_lh = HA_rand(movie_data_lh_loo, options, para, 'lh')
    new_niter_rh = HA_rand(movie_data_rh_loo, options, para, 'rh')
  elif align_algo[0:-1] in ['HA_swaroop_loo','HA_swaroop_shuffle_loo'] :
    new_niter_lh = HA_swaroop(movie_data_lh_loo, options, para, 'lh')
    new_niter_rh = HA_swaroop(movie_data_rh_loo, options, para, 'rh')
  elif align_algo[0:-1] in ['pHA_EM_loo', 'pHA_EM_shuffle_loo']:
    new_niter_lh = pHA_EM(movie_data_lh_loo, options, para, 'lh')
    new_niter_rh = pHA_EM(movie_data_rh_loo, options, para, 'rh')
  elif align_algo[0:-1] in ['pHA_EM_rand_loo']:
    new_niter_lh = pHA_EM_rand(movie_data_lh_loo, options, para, 'lh')
    new_niter_rh = pHA_EM_rand(movie_data_rh_loo, options, para, 'rh')
  elif align_algo == 'None' :
  ...
  if align_algo[0:-1] in ['HA_loo', 'HA_rand_loo' , 'HA_shuffle_loo','HA_swaroop_loo','HA_swaroop_shuffle_loo'] :
    ...
    movie_data_lh_zscore = stats.zscore(movie_data_lh[:,:,loo].T ,axis=0, ddof=1).T 
    movie_data_rh_zscore = stats.zscore(movie_data_rh[:,:,loo].T ,axis=0, ddof=1).T
  ...
  elif align_algo[0:-1] in  ['pHA_EM_loo', 'pHA_EM_rand_loo' , 'pHA_EM_shuffle_loo'] :
